...
class KehidupanBerkoperasi2Screen extends StatelessWidget {
  const KehidupanBerkoperasi2Screen({super.key});
      ...
      bottomNavigationBar: Padding(
        ...
        child: ZoomTapAnimation(
          child: ButtonFill(
            ...
            onPressed: () {
              //Navigator.pushNamed(context, '/kehidupan_berkoperasi_review');
            },
          ),
        ),
      ),
